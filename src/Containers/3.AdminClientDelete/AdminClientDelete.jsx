...
const AdminClientDelete = (props) => {
    ...
    const deleteUser = async () => {
        ...
        try {
            ...
            console.log("y", body)
            let resultado = await axios.post(raiz + "users/client/delete", body,config);
        ...
        if (dataUser.email !== "") {
            console.log("dataUser", dataUser)
                ...
                try {
                    ...
                    console.log(body)
                    let resultado = await axios.delete(raiz + "users/client/delete", body, config);
        ...
        <div className="designLogin">
            <div className="adminForm">
                <div className="selectorSection">
                    ...
                    <div className="btnAdmin adminSelected"><UserPlus name="search"></UserPlus><p> &nbsp;&nbsp;Eliminar usuario </p></div>
